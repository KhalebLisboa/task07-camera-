...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainimg = findViewById(R.id.maining);
        fab = findViewById(R.id.btn_floating);
        filter1 = findViewById(R.id.img_f1);
        filter2 = findViewById(R.id.img_f2);
        filter3 = findViewById(R.id.img_f3);
        filter4 = findViewById(R.id.img_f4);
        ...
        fab.setOnClickListener(v -> ImagePicker.Companion.with(MainActivity.this)
//                        .crop()	    			//Crop image
